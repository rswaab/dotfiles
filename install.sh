...
link "$DOTFILES/claude/hooks/sora-preflight.sh"    "$HOME/.claude/hooks/sora-preflight.sh"
link "$DOTFILES/claude/hooks/log-reads.sh"         "$HOME/.claude/hooks/log-reads.sh"
link "$DOTFILES/claude/hooks/sora-session-end.sh"  "$HOME/.claude/hooks/sora-session-end.sh"
